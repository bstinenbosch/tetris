...
public class View extends Application {
     ...
     * 
     * @param board
     *            the canvas to draw the gameboard on
     * @param grid
     ...
     * 
     * @param board
     *            the gameboard to draw the tetromino on
     * @param tetromino
	...
	if (color > 0) {
	    ...
	    board.fillRoundRect(coordinate.getX() * BLOCK_SIZE, (BOARD_HEIGHT - 1 - coordinate.getY()) * BLOCK_SIZE,
		    BLOCK_SIZE, BLOCK_SIZE, CORNER, CORNER);
	    board.strokeRoundRect(coordinate.getX() * BLOCK_SIZE, (BOARD_HEIGHT - 1 - coordinate.getY()) * BLOCK_SIZE,
		    BLOCK_SIZE, BLOCK_SIZE, CORNER, CORNER);
	}
    }
