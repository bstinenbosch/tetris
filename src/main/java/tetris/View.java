...
public class View extends Application {
     ...
     */
    GraphicsContext gotoGameScreen() {
     ...
     */
    void drawGrid(GraphicsContext board, Grid grid) {
     ...
     */
    void drawTetromino(GraphicsContext board, AbstractShape tetromino) {
        for (int i = 0; i < 4; i++) {
     ...
     */
    void clearBoard(GraphicsContext board) {
     ...
     */
    void gameOver(GraphicsContext board) {
    ...
    /**
     * stop is called when the application terminates.
     * Here any asynchronous threads should be terminated.
     */
    public void stop() {
        primaryStage.close();
    }
